...
import { Product, Category, UnitOfMeasure } from '@/types/product.types';
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="flex flex-col flex-1">
                <Navbar />
                <main className="mt-16 ml-64 flex-1 bg-gradient-to-br from-gray-50 via-white to-gray-100 min-h-screen">
                    {/* Breadcrumbs */}
